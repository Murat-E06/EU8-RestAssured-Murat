...
public class ORDSPojoGetRequestTest extends HRTestBase {
    ...
    public void regionTest() {
        ...
        System.out.println("region1.getRegion_id() = " + region1.getRId());//bu region_id ile aynı değil
        //pojo daki region clas ta @jsonProperty de değiştirebiliyoruz/ayarlayabiliyoruz.
...
//postman response alanından sadece 4 satırı almak istedik!
