...
public class getSpartanXml extends SpartanAuthTestBase {
    ...
    public void getSpartanXml(){
        ...
        given()
                ...
                .body("List.item[0].name",is("MarkoBiniBrock"))//Burada Meade yazıyordu hata verince bunu yazdım
                .body("List.item[0].gender",is("Male"))
                .log().all();

        //derste postmande "http://ergast.com/api/f1/drivers/alonso" yazıp xml formatında response aldık!!
        //xmlviewer.org sitesinde bu xml formatı yapıştırdık görsel bir sonuç verdi.
