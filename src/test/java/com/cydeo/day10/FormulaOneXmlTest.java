...
public class FormulaOneXmlTest {
    ...
    public void test1(){
        ...
        //get driverId
        String driverId = xmlPath.getString("MRData.DriverTable.Driver.@driverId");//parent to child gibi
                              // en son aynı satırdaki son elementin başına @ getiriyoruz
...
/*
    postmanden gelen response aşağıda bun göre path.leri yazdık yukarıdaki
